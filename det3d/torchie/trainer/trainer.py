...
class Trainer(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.max_miou_val = float('inf') * -1
        self.linkpath_best = osp.join(self.work_dir, 'best.pth')
    ...
    def val(self, data_loader, **kwargs):
        ...
        # TODO: ADD validate KHANH
        self.cur_miou_val = result_dict['results']['mIoU']
        print('\ncur miou val:', self.cur_miou_val)
    ...
    def register_training_hooks(
     ...
     # TODO: HOOK VAL KHANH
    def register_val_hooks(
        self, checkpoint_config=None, log_config=None
    ):
        """Register default hooks for val.

        Default hooks include:
            - CheckpointSaverHook
        """
        self.register_hook(self.build_hook(checkpoint_config, CheckpointValHook))
        if log_config is not None:
            self.register_logger_hooks(log_config)
